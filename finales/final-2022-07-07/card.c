...
{
    int points = 0;
    if(fst->number == snd->number-1){
        if(isFlush && upwardsFlush){
            points = 3;
        }else if((isFlush && !upwardsFlush) || (!isFlush && !upwardsFlush)){
            points = 5;
        }
    }else if(fst->number == snd->number+1){
        if((isFlush && upwardsFlush) || (!isFlush && !upwardsFlush)){
            points = 5;
        }else if(isFlush && !upwardsFlush){
            points = 3;
        }
